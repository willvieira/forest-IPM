...
RcppExport SEXP _forestIPM_getEigenValues(SEXP MSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_forestIPM_getEigenValues", (DL_FUNC) &_forestIPM_getEigenValues, 1},
    {NULL, NULL, 0}
};

RcppExport void R_init_forestIPM(DllInfo *dll) {
